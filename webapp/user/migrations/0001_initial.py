    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='계정 생성 일자')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='계정 수정 일자')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.CharField(max_length=40, null=True, verbose_name='학부')),
                ('sub_major', models.CharField(max_length=40, null=True, verbose_name='전공')),
            ],
            options={
                'verbose_name': 'Major',
